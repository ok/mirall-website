  ...
  return (
    <section className="py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="hero-gradient rounded-xl p-8 sm:p-16 text-center text-on-primary ambient-shadow relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
            <Link to="/download" className="bg-white text-primary px-10 py-5 rounded-lg font-black hover:bg-surface-container-low transition-colors">
              {t('cta.primaryButton')}
            </Link>
