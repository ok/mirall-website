    ...
    <DocsLayout
      ...
      seo={
        <Seo
          ...
          description="Understand how Mirall works: the peer-to-peer model, end-to-end encryption, membership approval, sharing without a second copy, mirroring, and how it compares to cloud transfer services."
