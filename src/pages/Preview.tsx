...
import { AppleLogo, WindowsLogo, LinuxLogo, Warning, Download as DownloadIcon, type Icon } from '@phosphor-icons/react'
...
const platforms: PlatformInfo[] = [
  { key: 'darwin-universal', Icon: AppleLogo, translationKey: 'download.platforms.mac', format: '.dmg' },
...
export default function Preview() {
  ...
  return (
    <>
      <Seo
        title="Mirall — Preview build"
        description="Internal preview channel for testing unreleased Mirall builds. Not for production use."
        path="/preview"
        noindex
      />
      <Navbar />
      <main className="pt-20">
        <section className="py-24 bg-background">
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            <div className="mb-16 inline-flex items-center gap-2 bg-red-50 border border-red-200 text-red-800 px-4 py-2 rounded-lg text-sm font-medium">
            ...
            {detectedPlatform && (() => {
              ...
              return (
                <div className="mb-16">
                  <a
                    href={`/preview/${detectedPlatform.key}`}
